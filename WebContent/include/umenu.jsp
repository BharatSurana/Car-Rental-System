...
<div id="ddblueblockmenu">
	  <div class="menutitle">&nbsp;Fleet Profiles</div>
		  <ul>
			...
			<li><a href="do?MOD=BOK&ACT=View&v=lux">Premium Cars</a></li>
			<li><a href="do?MOD=BOK&ACT=View&v=exe">Standard Cars</a></li>
			<li><a href="do?MOD=BOK&ACT=View&v=muv">SUV</a></li>
			<li><a href="do?MOD=BOK&ACT=View&v=eco">Economy Cars</a></li>
			<li><a href="do?MOD=BOK&ACT=View&v=mini">Mini Vans</a></li>			
		  </ul>
