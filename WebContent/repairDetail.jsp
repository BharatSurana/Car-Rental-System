<%@ page import="java.sql.*,java.util.*,net.CRS.CommonCar"%>
<%
ArrayList al=CommonCar.getDrivers();
ArrayList al1=CommonCar.getVehicles();
%>
...
<form id="form1" name="form1" method="post" action="do?MOD=MTN&ACT=AddRepair">
  <table width="80%" border="0" align="center">
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td><label>
        <input class="myButton" name="Submit" type="submit" class="redButton" onclick="MM_validateForm('VehicleName','','R','DriverName','','R','GarageName','','R','Cost','','R','Odometer','','R');return document.MM_returnValue" value="Submit Details" />
      </label></td>
      <td>&nbsp;</td>
    </tr>
  </table>
