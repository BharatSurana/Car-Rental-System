<%@ page contentType="text/html; charset=iso-8859-1" language="java" import="java.sql.*,
																			 ...
																			 net.CRS.*" errorPage="" %>
<%
ArrayList all = CommonCar.viewAllOilChanges();
int size = all.size();
%>
<style type="text/css">
<!--
...
<tr style="height:30px; padding:4px;">
    ...
    <td><div align="center"><a href="javascript:deleteOil(<%=(String)one.get(0)%>)"><button class="myButton">Delete</button></a></div></td>
</tr>
<% } %>
</table>
