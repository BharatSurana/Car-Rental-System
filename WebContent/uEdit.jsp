...
ArrayList all = CommonCar.viewUserDetails(id);
//int size = all.size();
...
<form id="form1" name="form1" method="post" action="do?MOD=BOK&ACT=doEdit">
  <table width="60%" border="0" align="center" cellpadding="5" cellspacing="2">
    ...
    <tr>
      ...
      <td colspan="2"><label>
        <input class="myButton" name="Submit" type="submit" onclick="MM_validateForm('Username','','R','Password','','R','Address','','R','City','','R','State','','R','Mobile','','R','Email','','RisEmail');return document.MM_returnValue" value="User Edit" />
      </label></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
