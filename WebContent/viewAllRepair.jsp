<%@ page contentType="text/html; charset=iso-8859-1" language="java" import="java.sql.*,
																			 ...
																			 net.CRS.*" errorPage="" %>
<%
ArrayList all = CommonCar.viewAllRepair();
int size = all.size();
%>
<style type="text/css">
<!--
...
<div class="header">View All Repair Details </div>
<br/>
...
<tr style="height:30px; padding:4px;">
    ...
    <td><div align="center"><a href="javascript:deleteRepair(<%=(String)one.get(0)%>)"><button class="myButton">Delete</button></a></div></td>
</tr>
<% } %>
</table>
