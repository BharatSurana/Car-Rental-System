...
<form id="form1" name="form1" method="post" action="do?MOD=MTN&ACT=AddVehicle" enctype="multipart/form-data">
  <table width="80%" border="0" align="center">
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td><label>
        <input class="myButton" name="Submit" type="submit" class="redButton" onclick="MM_validateForm('VehicleName','','R','VehicleNo','','R','Make','','R','Rs','','R','Average','','R','Cost','','R','InsurerName','','R','CompanyName','','R');return document.MM_returnValue" value="Add Vehicle" />
      </label></td>
      <td>&nbsp;</td>
    </tr>
  </table>
