...
<form id="form1" name="form1" method="post" action="do?MOD=MTN&ACT=AddOil">
  <table width="80%" border="0" align="center">
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td><label>
        <input class="myButton"  name="Submit" type="submit" class="redButton" onclick="MM_validateForm('VehicleName','','R','DriverName','','R','Cost','','R','Odometer','','R');return document.MM_returnValue" value="Add Detail" />
      </label></td>
      <td>&nbsp;</td>
    </tr>
  </table>
