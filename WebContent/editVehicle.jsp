...
ArrayList all = CommonCar.viewVehiclesByID(vid);
ArrayList al=CommonCar.getDrivers();
int size = all.size();
...
<form id="form1" name="form1" method="post" action="do?MOD=BOK&ACT=doBok">
  <table width="90%" align="center" style="border:#D22929 solid 2px;padding:5px;" border="0" >
    ...
    <tr>
      ...
      <td width="43%"><strong>Cost : </strong>\$.&nbsp;<%=one.get(7)%></td>
    </tr>
    <tr>
...
Km
    ...
    <tr>
      <td><label>
        <div align="right">
          <input class="myButton"  type="reset" name="Submit2" value="Reset"   class="redButton"/>
          </div>
      </label></td>
      <td><label>
        <input class="myButton" name="Submit" type="submit"  class="redButton" onclick="MM_validateForm('NoOfDays','','RisNum','KiloMeters','','RisNum','NoOfSeats','','RisNum');return document.MM_returnValue" value=" Book This Vehicle "/>
      </label></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
