...
<form id="form1" name="form1" method="post" action="do?MOD=MTN&ACT=AddFuel">
  <table width="80%" border="0" align="center">
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td><label>
        <input class="myButton" name="Submit" type="submit" class="redButton" onclick="MM_validateForm('VehicleName','','R','DriverName','','R','Quantity','','R','Cost','','R');return document.MM_returnValue" value="Add Fuel Details" />
      </label></td>
      <td>&nbsp;</td>
    </tr>
  </table>
