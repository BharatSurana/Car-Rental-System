 ...
 <form onSubmit="start();return false" action="#">
  <table width="539" border="0" align="center">
    ...
    <tr>
      ...
      <td width="286"><label>
        <input  size="40" maxlength="30" id="startpoint" value="melbourne, florida" type="text">
      </label></td>
    </tr>
    <tr>
      ...
      <td><label>
       <input  size="40" maxlength="30" id="endpoint" value="palm bay, florida" type="text">
      </label></td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
    ...
    <tr>
      ...
      <td><label>
        <input class="myButton" type="submit" name="Submit" value="Start Travelling" />
      </label></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
...
<font color="#FF0000"><center>
 ...
 <script type="text/javascript">
    ...
    if (GBrowserIsCompatible()) {
      ...
      map.setCenter(new GLatLng(28.040169, -80.594330), 10);
