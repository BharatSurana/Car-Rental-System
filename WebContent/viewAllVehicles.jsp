<%@ page contentType="text/html; charset=iso-8859-1" language="java" import="java.sql.*,
																			 ...
																			 net.CRS.*" errorPage="" %>
<%
ArrayList all = CommonCar.viewAllVehicles();
int size = all.size();
%>
<script>
...
<h3>View all the Vehicle Details.<br/>If you want to add more Vehicle then <a href="do?MOD=MTN&ACT=VclAdd">Click Here.</a></h3><br/>
...
<table width="90%" align="center" style="border:#D22929 solid 2px;padding:5px;" border="0" >
  ...
  <tr>
    <td>
    <div align="center"><a href="do?MOD=MTN&ACT=editVehicle&vId=<%=(String)one.get(0)%>"><button class="myButton">Edit Vehicle</button></a> </div></td>
    <td>&nbsp;&nbsp;&nbsp;<a href="javascript:deleteVehicle(<%=(String)one.get(0)%>)"><button class="myButton">Delete Vehicle</button></a></td>
    <td>&nbsp;</td>
  </tr>
</table>
<br/>
