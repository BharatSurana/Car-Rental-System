<%@ page contentType="text/html; charset=iso-8859-1" language="java" import="java.sql.*,
																			 ...
																			 net.CRS.*" errorPage="" %>
<%
ArrayList all = CommonCar.viewAllPendingBooking();
int size = all.size();
%>																			 
<style type="text/css">
<!--
...
<div class="header">View Your Customer's Pending Booking Request</div>
<br/>
...
<form name="bookingForm" id="bookingForm" action="do?MOD=MTN&ACT=bookAction" method="post">
  <tr style="height:30px; padding:4px;">
	...
	<td><div align="center"><input class="myButton" type="submit" value=" Go " /></div></td>
  </tr>
</form>
  <% } %>
</table>
