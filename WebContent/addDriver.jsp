...
<form id="form1" name="form1" method="post" action="do?MOD=MTN&ACT=AddDriver" >
  <table width="80%" border="0" align="center">
    ...
    <tr>
      ...
      <td>&nbsp;</td>
      <td><label>
        <input class="myButton" name="Submit" type="submit" class="redButton" onclick="MM_validateForm('FirstName','','R','LastName','','R','Address','','R','City','','R','State','','R','MobileNo','','R','LicenseNo','','R','Experiance','','RisNum');return document.MM_returnValue" value="Add Driver" />
      </label></td>
      <td>&nbsp;</td>
    </tr>
  </table>
